        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form method="POST" wire:submit="save">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="border-2 border-gray-300 p-2 w-full" wire:model.live="form.title"
                        id="title" value="">
                </div>

                @error('form.title')
                    <label class="text-sm text-gray-600"> <span class="text-red-500">{{ $message }}</span></label>
                @enderror
                <div class="mb-4">
                    <label class="text-xl text-gray-600">Slug</label></br>
                    <input type="text" class="border-2 border-gray-300 p-2 w-full" wire:model="form.slug"
                        name="slug" id="description" placeholder="(Optional)">
                </div>
                @error('form.slug')
                    <label class="text-sm text-gray-600"> <span class="text-red-500">{{ $message }}</span></label>
                @enderror
                <div class="mb-4">
                    ...
                    <input type="text" class="border-2 border-gray-300 p-2 w-full" wire:model="form.description"
                ...
                <div class="mb-4">
                    ...
                    <input type="date" class="border-2 border-gray-300 p-2 w-full" wire:model="form.deadline"
                        name="description" id="description" placeholder="(Optional)">
                </div>
                {{-- <div class="mb-8">
                ...
                <div class="flex p-1">
                    ...
                    <button role="submit" class="p-3 bg-blue-500 text-white hover:bg-blue-400" required>Submit <div
                            wire:loading>
                            @include('loading')
                        </div> </button>
                </div>
